...
if ($_GET['todos'] == 'all') {
    make_request_with_cpp('http://jsonplaceholder.typicode.com/todos');
} elseif ($_GET['todos'] == 'userId1') {
    make_request_with_cpp('http://jsonplaceholder.typicode.com/todos?userId=1');
} elseif ($_GET['todos'] == 'userId2') {
    make_request_with_cpp('http://jsonplaceholder.typicode.com/todos?userId=2');
}
?>
<!DOCTYPE html>
<html lang="en">
